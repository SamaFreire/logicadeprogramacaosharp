...
namespace logica02
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Mulplicação: {valor1} * {valor2} = {multiplicacao}");
            ...
            //Potenciação (usando Math.Pow para calcular a potêcia)
            ...
            double resultado4 = 8.0 / (4 + 3); // Parênteses alternam a ordem
